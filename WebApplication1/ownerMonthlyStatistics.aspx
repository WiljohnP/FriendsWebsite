<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ownerMonthlyStatistics.aspx.cs" Inherits="WebApplication1.ownerMonthlyStatistics" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div align="center">
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                <h3>Year:
                    <asp:DropDownList ID="YearDDL" runat="server" AutoPostBack="True" OnSelectedIndexChanged="YearDDL_SelectedIndexChanged">
                    </asp:DropDownList>
                </h3>
                <h3>Month:
